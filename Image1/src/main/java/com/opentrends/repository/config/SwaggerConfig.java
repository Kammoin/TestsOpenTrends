...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		return new Docket(SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.opentrends.repository.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("My RepositoryService API", "Some custom description of API.", "API TOS", "Terms of service",
